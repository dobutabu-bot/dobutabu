import { BriefcaseBusiness, Download, HandCoins, ReceiptText, WalletCards } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      ...
      <DetailHero
        ...
        actions={
          <>
            <a href={`/api/reports/collections/${collection.id}/pdf`} className="secondary-action">
